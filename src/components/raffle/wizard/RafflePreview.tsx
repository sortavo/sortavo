    ...
    <div className={cn("bg-muted/30 rounded-lg overflow-hidden border", className)}>
      ...
      <div className="overflow-y-auto max-h-[600px] bg-white">
        ...
        <div className="p-4 space-y-4">
          ...
          {/* Countdown Preview */}
          {drawDate && (
            <Card className="p-3 bg-gradient-to-r from-gray-50 to-gray-100 border">
            ...
            <div className="grid grid-cols-5 gap-1">
              {Array.from({ length: 15 }).map((_, i) => (
                <div 
                  key={i}
                  className={cn(
                    "aspect-square rounded text-[9px] font-medium flex items-center justify-center",
          ...
          {/* FAQ Preview */}
          <div className="space-y-2">
            <h3 className="text-sm font-semibold text-gray-900">Preguntas Frecuentes</h3>
