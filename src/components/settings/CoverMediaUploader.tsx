...
import { Loader2, Upload, X, GripVertical, Play, Image as ImageIcon, Film } from "lucide-react";
    ...
    <div className="space-y-3">
      <div className="flex items-center gap-4 overflow-x-auto pb-2">
        ...
        {media.length < maxItems && (
          <label
            className={cn(
              "h-24 w-32 rounded-lg border-2 border-dashed border-border bg-muted/50 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-primary/50 hover:bg-muted transition-colors flex-shrink-0",
      ...
      <p className="text-xs text-muted-foreground">
        Arrastra para reordenar. Máximo {maxItems} medios. Imágenes: JPG, PNG, GIF, WebP (máx 5MB). Videos: MP4, WebM (máx 50MB).
      </p>
    </div>
  );
}
